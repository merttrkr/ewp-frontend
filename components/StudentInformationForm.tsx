      ...
      >
        ...
        <Flex>
          <Stack w="50%" spacing={4} p="5">
            ...
            <SelectAutoComplete placeHolder="placeholder.." selectLabel="ISCED Kodu ve Konu Alanları" />
            <TextInput placeHolder="placeholder.." name="0" label="Yıl Bazında Toplam Ay sayısı" />
          </Stack>
          <Stack w="50%" spacing={4} p="5">
            <SelectAutoComplete placeHolder="placeholder.." selectLabel="Gönderen Kurumun İlgili Bölümü / Departmanı" />
            <SelectAutoComplete placeHolder="placeholder.." selectLabel="Alıcı Kurumun İlgili Bölümü / Departmanı" />
            <SelectAutoComplete placeHolder="placeholder.." selectLabel="Hangi Akademik Yıllar Arasında Bitiyor ?" />
            <SelectAutoComplete placeHolder="placeholder.." selectLabel="Gönderen Kurumun İlgili Bölümü / Departmanı" />
            <CheckBoxInput
              placeHolder="Karma"
            ...
            />
            <HStack spacing={4}>
              <SelectAutoComplete placeHolder="placeholder.." selectLabel="İstenilen Yabancı Dil" />
              <Box w={"50%"}>
                <SelectAutoComplete placeHolder="placeholder.." selectLabel="Seviyesi" />
              </Box>
            </HStack>
          </Stack>
        </Flex>
        <Flex p="5">
          <SelectAutoComplete placeHolder="placeholder.." selectLabel="Öğrenim Seviyesini Seçiniz" />
        </Flex>
